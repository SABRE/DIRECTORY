<?
	...
	unset($title);
	if(strlen($classified->title)>20){
			$classified->title = substr($classified->title,0,20).'...';	
	}
	if($show_detailLink){
	...
	if(strlen($classified->summarydesc)>200){
			 $classified->summarydesc = substr($classified->summarydesc,0,200).'...';	
	} 
