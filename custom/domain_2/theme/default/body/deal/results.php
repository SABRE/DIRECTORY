<?  
    ...
    $editCoreUrl = $includeUrl.EDIR_CORE_FOLDER_NAME."/".PROMOTION_FEATURE_FOLDER;
...
<div class="document">
    ...
    <div class="side-bar">
        ...
        <? include(system_getFrontendPath("results_left_section.php"));?>
        <? //include(system_getFrontendPath("results_left_section_old.php"));?>
        ...
        <? include($frontEndUrl."featured_promotion_review.php"); ?>
