...
?>
	...
	<div class="navigationbuttons">
		...
		<ul class="navbuttons">
			...
			<li id="nhdproperty"><a href="<?echo($navbuttonurl)?>listing/property-wildlife-nutrition"><img src="<?echo($navbuttonurl)?>custom/domain_2/theme/default/schemes/default/images/iconography/Property.png" alt="Property and Preserves"/></a>
			</li>
