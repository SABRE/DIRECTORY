...
?>
    ...
    <? if ($aux_modal_box != "profileLogin") { ?>
        <link href="<?=system_getStylePath("structure.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['PHP_SELF'], "/".MEMBERS_ALIAS) !== false) && 
        ...
        $loadMembersCss) { ?>
        <link href="<?=system_getStylePath("members.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['PHP_SELF'], "popup.php") !== false) || 
        ...
        <link href="<?=system_getStylePath("popup.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if (((LOAD_MODULE_CSS_HOME == "on") || 
        ...
        <link href="<?=system_getStylePath("front.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if (ACTUAL_MODULE_FOLDER == BLOG_FEATURE_FOLDER || 
        ...
        <link href="<?=system_getStylePath("blog.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['PHP_SELF'], "order_listing.php") !== false) || 
        ...
        <link href="<?=system_getStylePath("order.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if (((string_strpos($_SERVER['PHP_SELF'], "favorites") !== false) || 
        ...
        <link href="<?=system_getStylePath("results.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['REQUEST_URI'], ".html") !== false) && 
        ...
        (ACTUAL_MODULE_FOLDER != BLOG_FEATURE_FOLDER)) { ?>
        <link href="<?=system_getStylePath("detail.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['REQUEST_URI'], ALIAS_ADVERTISE_URL_DIVISOR.".php") !== false || 
        ...
        ((ACTUAL_MODULE_FOLDER != BLOG_FEATURE_FOLDER))) { ?>
        <link href="<?=system_getStylePath("advertise.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((string_strpos($_SERVER['PHP_SELF'], "profile/index.php") !== false) || 
        ...
        <link href="<?=system_getStylePath("profile.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
        <link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/profile.css" rel="stylesheet" type="text/css" media="all" />
    <? } ?>

    <link href="<?=system_getStylePath("content_custom.css", "default");?>" rel="stylesheet" type="text/css" media="all" />
    <link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/content_custom.css" rel="stylesheet" type="text/css" media="all" />

    <link href="<?=system_getStylePath("print.css", "default");?>" rel="stylesheet" type="text/css" media="print" />
