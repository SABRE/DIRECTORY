...
.resultsMessage, .resultsMessage h1, .content .resultsMessage h2
{ color:#<?=SCHEME_COLORTEXT?> !important; }
...
/*Marker BuyersGuideException*/
	...
	.content-custom h6, .package h2, .popupWrapper h2, .modal-content input
	{ color:#<?=SCHEME_COLORTEXT?> !important; }
...
table.standard-tableTOPBLUE th, .standard-tabletitle, table.levelTable th.levelTitle, .tabs li.tabActived a, .tabs li.tabActived a:visited, .standardForm th.wrapcaption, p.standardButton button, .input-button-form button, input.input-button-form, button.input-button-form, .addImageForm, p.standardButton a:link, p.standardButton a:visited, p.standardButton a:active, .standardForm td.TimageFile, .standardForm td.TaddImagetxt, .standardForm th.wrapcaption, .user-info p span, table.standard-table td.treeView table.tableCategoriesADDED input, table.standard-table td.treeView table.tableCategoriesADDED button, .modal-content .content-custom p, .modal-content .content-custom span, .modal-content .content-custom h1, .modal-content .content-custom h2, .modal-content .content-custom h3, .modal-content .content-custom h4, .modal-content .content-custom h5, .modal-content .content-custom h6, .login a:link, .login a:visited, .login a:active
...
/*Marker InvoiceEnvironment*/

table.standard-tableTOPBLUE th, .domainItems h2.domainItemsTitlem, .modal-content h2, .modal-content h3,
p.standardButton button, .input-button-form button, input.input-button-form, button.input-button-form, 
.addImageForm, p.standardButton a:link, p.standardButton a:visited, p.standardButton a:active, .standard-tabletitle
{ color:#<?=SCHEME_COLORTITLEBORDER?> !important; }
...
table.standard-tableTOPBLUE th, .standard-tabletitle, table.levelTable th.levelTitle
{ color:#<?=SCHEME_COLORTITLEBORDER?> !important; }
...
.content h2, table.standard-tableTOPBLUE th, table.standard-tableTOPBLUE th, 
.domainItems h2.domainItemsTitlem, .modal-content h2, .modal-content h3, p.standardButton button, 
.input-button-form button, input.input-button-form, button.input-button-form, .addImageForm, 
p.standardButton a:link, p.standardButton a:visited, p.standardButton a:active, .standard-tabletitle,
.memberMenu ul li a, .memberMenu ul li a:visited, table.levelTable th.levelTitle,
.tabs li.tabActived a, .tabs li.tabActived a:visited
{ color:#<?=SCHEME_COLORTEXT?> !important; }

/*Marker MembersSpa*/

/*Marker Spa Exception5*/
...
td a.addImageForm, table.standard-tableTOPBLUE th, .standard-tabletitle, table.levelTable th.levelTitle, p.standardButton button, .input-button-form button, input.input-button-form, button.input-button-form, .addImageForm, p.standardButton a:link, p.standardButton a:visited, p.standardButton a:active
{ color:#<?=SCHEME_COLORNAVBARLINK?>; }

/*Marker eDirCompact*/

/*Marker MembersEnviroment*/

table.levelTable td.levelTopdetail, 
table.levelTopdetail th
{ color:#<?=SCHEME_COLORBACKGROUND?>; }

p.input-button-form button,
p.input-button-form button:hover,
table.standard-table td.treeView table.tableCategoriesADDED button.input-button-form,
p.standardButton button,
table.levelTable th.levelTitle,
td a.addImageForm
{ color:#<?=SCHEME_COLORBACKGROUND?> !important; }
...
.standardForm td.IimageFile input
{ color:#<?=SCHEME_COLORTITLEBORDER?> !important; }
...
.content .content-profile .itemSearchResults h2.standardSubTitle,
td a.addImageForm
{ color:#<?=SCHEME_COLORTITLE?> !important; }
...
{ background:#<?=SCHEME_COLORLINK?> !important; color:#<?=SCHEME_COLORTITLE?> !important; }
