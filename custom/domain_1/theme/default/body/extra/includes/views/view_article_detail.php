<?
    ...
    if (USE_GALLERY_PLUGIN) { 
        ...
        //$articleGallery = system_showFrontGallery($article->getGalleries(), $article->getNumber("level"), $user, GALLERY_DETAIL_IMAGES, "article", $tPreview);
 		$articleGallery = system_showFrontGallery_detail($article->getGalleries(), $article->getNumber("level"), $user, GALLERY_DETAIL_IMAGES, "article", $tPreview);
    }
    ...
    */
	...
	$detailFileName = $includeUrl."includes/views/view_article_detail_code.php";
