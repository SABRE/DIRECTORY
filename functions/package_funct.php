						...
						if($array_package_items[$j]["module"] == "custom_package"){
							...
							if ($members){ 
								...
								if ($array_package_items[$j]["price"]>0){
									...
									$error = false;
									system_mail($contactObj->getString("email"), $subject, $body, EDIRECTORY_TITLE." <$sitemgr_email>", $emailNotification->getString("content_type"), "", $emailNotification->getString("bcc"), $error);
