		...
		foreach($toapproved as $approve){
			...
			if (($domain_status == "A") && (permission_hasSMPermSection(constant($permission))) ){
				...
				if (string_strpos($approve["item_type"], "review") !== false){ //link to view item is different for reviews
					...
					$linkViewURI = "/".SITEMGR_ALIAS."/".$approve["item_folder"]."/view.php?id=".$item_id;
					...
					$linkViewURI = "/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/view.php?id=".$item_id;
					$linkViewQSTRING = "id=".$item_id;
					$linkViewItem = "<a class=\"left\" href=\"javascript: void(0);\" onclick=\"changeDomainInfo(".$approve["domain_id"].",'".DEFAULT_URL."','".$linkViewURI."','".$linkViewQSTRING."','false', 'true')\" title=\"".$approve["item_title"]."\">".system_showTruncatedText($approve["item_title"], 45)."</a>";
				} else{
					$linkViewURI = "/".SITEMGR_ALIAS."/".$approve["item_folder"]."/view.php?id=".$item_id;
				...
				if ($approve["content"] && string_strpos($approve["item_type"], "review") !== false){ //for reviews
					...
					$linkViewReviewURI = "/".SITEMGR_ALIAS."/review/view.php?item_id=".$item_id."&item_type=".str_replace("review_","",$approve["item_type"])."&id=".$review_id;
					...
					$linkApproveURI = "/".SITEMGR_ALIAS."/review/index.php?item_type=".str_replace("review_","",$approve["item_type"])."&id=".$review_id."&openapprove=yes";
					...
					$linkEditURI = "/".SITEMGR_ALIAS."/review/index.php?item_type=".str_replace("review_","",$approve["item_type"])."&id=".$review_id."&openedit=yes";
					...
					$approve["content"] = str_replace("<br />", "", $approve["content"]);
					$linkViewReviewURI = "/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/comments/view.php?post_id=".$item_id."&id=".$comment_id;
					...
					$linkApproveURI = "/".SITEMGR_ALIAS."/".$approve["item_folder"]."/settings.php?id=".$item_id;
