<?
	...
	function cal_display_month_domain($property_id = false, $this_date=false, $hilight="Y", $next_links="Y", $price_type="week", $link_all_days=false) {
		...
		///////////////////////////////////////////////
		echo "<div class=\"search-form\">".system_showText(LANG_BROWSEEVENTSBYDATE)."</div>";
