...
<?
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
    	...
    	$sql = "SELECT id, caption FROM Banner WHERE status = 'P'";

		$result2 = mysql_query($sql,$linkDomain);
		while ($row2 = mysql_fetch_assoc($result2)){
			$sql = "INSERT INTO To_Approved (domain_id, item_id, item_type, item_title) VALUES (".$rowDomain["id"].",".$row2["id"].",'banner','".$row2["caption"]."')";
			mysql_query($sql,$link);
		}
