				...
				if (count($line) > count($sample_header)) {
					...
					for ($i=0; $i<count($sample_header); $i++) {
						...
						if ($i == 0 || $i == 1 || $i == 16 || $i == 22 || $i == 23 || $i == 24 || $i == 25 || $i == 26 || $i == 28 || $i == 30 || $i == 32 || $i == 34 || $i == 36 || $i == 39 || $i == 40 || $i == 44 || $i == 45) {
								...
								if ($line[$i]) {
									...
									if ($validStart && $validEnd && $validStartTime && $validEndTime){
										...
										if ($startDateStr == $endDateStr){
											$startTimeStr = "";
											$start_time_am_pm = string_strtolower($line[25]);
											$end_time_am_pm = string_strtolower($line[27]);
							...
							if ($i == 28 || $i == 30 || $i == 32 || $i == 34 || $i == 36){ //validate locations
				...
				<html>
					...
					<body>
						<div class=\"email_style_settings\">
							...
							$sitemgr_msg .= "<br /><a href=\"http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?type=event&log_id=".$importlogObj->getNumber("id")."\" target=\"_blank\">http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?type=event&log_id=".$importlog_id."</a><br /><br />
						</div>
					</body>
				</html>";
				...
				<html>
					...
					<body>
						<div class=\"email_style_settings\">
							...
							You can see details at:<br />";
							$sitemgr_msg .= "<br /><a href=\"http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?type=event&log_id=".$importlogObj->getNumber("id")."&preview=true\" target=\"_blank\">http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?type=event&log_id=".$importlogObj->getNumber("id")."&preview=true</a><br /><br />
						</div>
					</body>
				</html>";
