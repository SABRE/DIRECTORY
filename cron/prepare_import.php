				...
				if (count($line) > count($sample_header)) {
					...
					for ($i=0; $i<count($sample_header); $i++) {
						...
						if ($i == 0 || $i == 1 || $i == 16 || $i == 21 || $i == 23 || $i == 25 || $i == 27 || $i == 29 || $i == 32 || $i == 33 || $i == 38 || $i == 39) {
							...
							if ($i == 21 || $i == 23 || $i == 25 || $i == 27 || $i == 29){ //validate locations
				...
				<html>
					...
					<body>
						<div class=\"email_style_settings\">
							...
							$sitemgr_msg .= "<br /><a href=\"http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?log_id=".$importlogObj->getNumber("id")."\" target=\"_blank\">http://".$default_url."/".SITEMGR_ALIAS."/import/importlog.php?log_id=".$importlog_id."</a><br /><br />
						</div>
					</body>
				</html>";
