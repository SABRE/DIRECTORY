...
?>
		...
		<div class="content">
			...
			<p style="text-align: center; padding: 10px;">
				<a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/login.php" class="linkLogin"><?=system_showText(LANG_MSG_CLICK_IF_YOU_HAVE_PASSWORD);?></a>
			</p>

			<p style="text-align: center;"><?=system_showText(LANG_MSG_NOT_A_MEMBER)?>  <a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>.php" class="linkLogin"><b><?=ucfirst(system_showText(LANG_LABEL_CLICK_HERE))?></b></a> <?=system_showText(LANG_MSG_FOR_INFORMATION_ON_ADDING_YOUR_ITEM)?> <?=EDIRECTORY_TITLE?>.</p>
