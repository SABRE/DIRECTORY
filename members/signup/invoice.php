...
?>
	...
	<div class="extendedContent spaSpaceContent">
		...
		<? } elseif ((!$bill_info["listings"]) && (!$bill_info["events"]) && (!$bill_info["banners"]) && (!$bill_info["classifieds"]) && (!$bill_info["articles"])) { ?>
			...
			<?
			if ($itemCount > 1) echo "<p class=\"informationMessage\">Already registered users should use <a href=\"".DEFAULT_URL."/".MEMBERS_ALIAS."/billing/index.php\">members check out area</a>.</p>";
