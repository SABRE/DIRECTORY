<?
    ...
    $fields = "id, type, status, suspended_sitemgr, account_id, expiration_setting, renewal_date, impressions, `caption`";
    $letterField = "`caption`";
	...
	$pageObj = new pageBrowsing("Banner", $screen, RESULTS_PER_PAGE, $_GET["newest"] ? "id DESC" : $manageOrder, $letterField, $letter, $where, $fields);
	$banners = $pageObj->retrievePage("array");

	$paging_url = DEFAULT_URL."/".MEMBERS_ALIAS."/".BANNER_FEATURE_FOLDER."/index.php";
								...
								<tr>
									<td width="50%">
										<table align="center" border="0" cellpadding="0" cellspacing="0" class="warningBOX">
											<tr>
												<th><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/billing/index.php" class="warningBOXcontent"><?=system_showText(LANG_MSG_CONTINUE_TO_PAY_BANNER)?></a></th>
