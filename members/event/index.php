<?
	...
	$paging_url = DEFAULT_URL."/".MEMBERS_ALIAS."/".EVENT_FEATURE_FOLDER."/index.php";
                                ...
                                <tr>
                                    <td width="50%">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="warningBOX">
                                            <tr>
                                                <th><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/billing/index.php" class="warningBOXcontent"><?=system_showText(LANG_MSG_CONTINUE_TO_PAY_EVENT)?></a></th>
