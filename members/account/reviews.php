			...
			<tr>
				<th class="tabsBase">
					<ul class="tabs">
						<? if (SOCIALNETWORK_FEATURE == "on") { ?>
                            <li id="tab_1">
                                <a href="<?=DEFAULT_URL;?>/<?=MEMBERS_ALIAS?>/account/account.php?type=tab_1"><?=system_showText(LANG_LABEL_PERSONAL_PAGE)?></a>
                            </li>
						<? } ?>
						<li id="tab_2">
							<a href="<?=DEFAULT_URL;?>/<?=MEMBERS_ALIAS?>/account/account.php?type=tab_2"><?=system_showText(LANG_LABEL_ACCOUNT_SETTINGS)?></a>
						</li>
						<? if(($review_enabled == "on" || $review_article_enabled == "on" || $review_promotion_enabled == "on") && $commenting_edir) { ?>
						...
						<? } ?>
						<li id="tab_4">
							<a href="<?=DEFAULT_URL;?>/<?=MEMBERS_ALIAS?>/account/quicklists.php"><?=system_showText(LANG_LABEL_QUICKLIST)?></a>
						</li>
						<li id="tab_5">
...
<script language="javascript" type="text/javascript">
	...
	function changePageProfile(url, page) {
