...
?>
	...
	$openCheckout	=   string_strpos($_SERVER["PHP_SELF"], "".MEMBERS_ALIAS."/billing");
	$openHistory	=	((string_strpos($_SERVER["PHP_SELF"], "".MEMBERS_ALIAS."/transactions") !== false) || (string_strpos($_SERVER["PHP_SELF"], "".MEMBERS_ALIAS."/invoices")));
	...
	<div class="sidebar">
		...
		<div class="memberMenu">
			...
			<ul id="navBar_submenu_listing" <? if (!$openListing) {?> style="display:none" <?}?> >
				<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=LISTING_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
				<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=LISTING_FEATURE_FOLDER;?>/listinglevel.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
			</ul>
			<? 
			if (PROMOTION_FEATURE == "on" && CUSTOM_PROMOTION_FEATURE == "on" && CUSTOM_HAS_PROMOTION == "on")
				...
				<ul id="navBar_submenu_promotion" <? if (!$openPromotion) {?> style="display:none" <?}?> >
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=PROMOTION_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=PROMOTION_FEATURE_FOLDER;?>/deal.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
				</ul>
			<? } ?>
			...
			<? if (BANNER_FEATURE == "on" && CUSTOM_BANNER_FEATURE == "on") { ?>
				...
				<ul id="navBar_submenu_banner" <? if (!$openBanner) {?> style="display:none" <?}?> >
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=BANNER_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=BANNER_FEATURE_FOLDER;?>/add.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
				</ul>
			<? } ?>
			...
			<? if (EVENT_FEATURE == "on" && CUSTOM_EVENT_FEATURE == "on") { ?>
				...
				<ul id="navBar_submenu_event" <? if (!$openEvent) {?> style="display:none" <?}?> >
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=EVENT_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=EVENT_FEATURE_FOLDER;?>/eventlevel.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
				</ul>
			<? } ?>			
			...
			<? if (CLASSIFIED_FEATURE == "on" && CUSTOM_CLASSIFIED_FEATURE == "on") { ?>
				...
				<ul id="navBar_submenu_classified" <? if (!$openClassified) {?> style="display:none" <?}?> >
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=CLASSIFIED_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=CLASSIFIED_FEATURE_FOLDER;?>/classifiedlevel.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
				</ul>
			<? } ?>
			...
			<? if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") { ?>
				...
				<ul id="navBar_submenu_article" <? if (!$openArticle) {?> style="display:none" <?}?> >
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=ARTICLE_FEATURE_FOLDER;?>/"><?=system_showText(LANG_MENU_MANAGE);?></a></li>
					<li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/<?=ARTICLE_FEATURE_FOLDER;?>/article.php"><?=system_showText(LANG_MENU_ADD);?></a></li>
				</ul>
			<? } ?>
		</div>
				...
				<div class="sidebar">
					...
					<ul class="memberMenu">
						...
						<? if (SOCIALNETWORK_FEATURE == "off") { ?>
							<li><a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>.php"><?=system_showText(LANG_LABEL_ADD_NEW_ACCOUNT);?></a></li>
						<? } ?>
					</ul>
				</div>
		<? } ?>
