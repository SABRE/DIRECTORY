            ...
            ?>
				...
				<!--<div class="level-detail">-->
					...
					<?	if(SELECTED_DOMAIN_ID > 0){
							...
							include($includeUrl."includes/views/view_classified_detail.php");
							echo "</div>"
					?>
							<div class="sidebar">
                        	<? $signUpListing = true; include(system_getFrontendPath("detail_info.php", "frontend", false, CLASSIFIED_EDIRECTORY_ROOT)); ?>
							<? $signUpListing = true; include(system_getFrontendPath("detail_maps.php", "frontend", false, CLASSIFIED_EDIRECTORY_ROOT)); ?>
							</div>
					<?		echo "</div>";
							}else{
					...
					<div class="sidebar">
                        <? $signUpClassified = true; include(system_getFrontendPath("detail_info.php", "frontend", false, CLASSIFIED_EDIRECTORY_ROOT)); ?>
						<? $signUpClassified = true; include(system_getFrontendPath("detail_maps.php", "frontend", false, CLASSIFIED_EDIRECTORY_ROOT)); ?>
					</div>
