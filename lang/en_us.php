<?
	...
	# ----------------------------------------------------------------------------------------------------
	# JAVASCRIPT LANGUAGES VARIABLES - ANY CHANGE ON THESE CONSTANTS MUST ALSO BE APPLIED ON THE CORRESPONDING JS FILE (lang/en_us.js)
	# ----------------------------------------------------------------------------------------------------
	...
	define("LANG_LISTING_CONTACT", "Contact ".ucfirst(LISTING_FEATURE_NAME));
	//E-mail an inquiry
	...
	define("LANG_REVIEWBETHEFIRST", "Leave a review!");
	//Offered by
	...
	//Search results
	define("LANG_SEARCHRESULTS", "Results");
	//Results
	...
	//Search results "in category"
	define("LANG_SEARCHRESULTS_INCATEGORY", "from");
	...
	define("LANG_MSG_REPLYTHISCOMMENT", "Reply to this comment");
	//Please type a valid e-mail
	...
	//Request for banner to be featured in chosen State
	define("LANG_FEATURE_BANNERINLOCATION", "Request for banner to be featured in chosen ".LOCATION3_LABEL);
	//Only one banner will be approved for a specific category-location combination by the site  manager.
	define("LANG_FEATURE_BANNERINLOCATIONNOTE", "Only one banner will be approved for a specific category-".LOCATION3_LABEL." combination, by the site manager.");
	//Updating the locations will remove the approval of the site manager.
	define("LANG_FEATURE_BANNERINLOCATIONNOTE2", "Updating the locations will remove the approval of the site manager.");
	//Country is required
	define("LANG_MSG_LOC1_IS_REQUIRED", ucfirst(LOCATION1_LABEL)." is required.");
	//Region is required
	define("LANG_MSG_LOC2_IS_REQUIRED", ucfirst(LOCATION2_LABEL)." is required.");
	//State is required
	define("LANG_MSG_LOC3_IS_REQUIRED", ucfirst(LOCATION3_LABEL)." is required.");
	//Denied
	define("LANG_LABEL_DENIED", "Denied");
	//The site manager has not approved your request, please choose a different location.
	define("LANG_LABEL_DENIED_APPLICATION", "The site manager has not approved your request, please choose a different location.");
	//The site manager has approved your request to be featured in your selected location.
	define("LANG_LABEL_APPROVED_APPLICATION", "The site manager has approved your request to be featured in your selected location.");
	//Type a keyword
	define("LANG_LABEL_SEARCHKEYWORDTIP", "Type a keyword");
	
	// Search by Location
	define("LANG_LOCATION_FILTER_LABEL", "Search by Location");
	//Search by ZIPCODE
	define("LANG_PROXIMITY_FILTER_LABEL", "Search by Zipcode");
	//Select a Location first
	define("LANG_SELECT_LOC3_FIRST", "Select Country and State first");
	//Keyword
	define("LANG_LABEL_SEARCHKEYWORD2", "Keyword(Optional)");
//Select a Category
	define("LANG_SEARCH_LABELCBSUBCATEGORY", "Select a Subcategory");