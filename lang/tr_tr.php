<?
	...
	//"No results content"
	define("LANG_SEARCH_NORESULTS", "<h1>Üzgünüm!</h1><p>Aramanız sonuç döndürür. Bu sıradışı olsa kullandığınız arama terimi biz gerçekten eşleşen herhangi bir içerik yok biraz genel veya olduğunda, zaman zaman olur.</p><h2>Öneriler:</h2>Arama terimlerinizi daha spesifik olun.<br />Yazım kontrol edin.<br />Arama bölümüne göz atarak deneyin aracılığıyla bulamazsanız.<br /><br /><p>Size yanlışlıkla buraya gelmiş inanıyoruz, burada bir sorun bildirmek için site yöneticisi ile irtibata <a href=\"[EDIR_LINK_SEARCH_ERROR]\">geçiniz</a>.</p>");
	//Image
