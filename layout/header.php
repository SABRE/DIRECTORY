...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xml:lang="en" lang="en">
    ...
    <head>
		...
		<? include(THEMEFILE_DIR."/".EDIR_THEME."/layout/addtohead.php");?>
    ...
    <body>
        ...
        <!-- Top navbar options  -->
        <?=front_navbarOptions(false);?>
        <?//=front_navbarOptions(true);?>
        ...
        <div id="header-wrapper">
            ...
            <div id="header">
                ...
                <h1 class="logo">
                    <a id="logo-link" href="<?=NON_SECURE_URL?>" target="_parent" title="<?=EDIRECTORY_TITLE?>" <?=system_getHeaderLogo();?>>
                        <?=EDIRECTORY_TITLE?>
                    </a>
                </h1>
				...
				<? include(THEMEFILE_DIR."/".EDIR_THEME."/layout/sponsors.php");?>
        ...
        <!-- DIV for the main content. This DIV is closed in the file footer.php test the update -->
