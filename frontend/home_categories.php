    ...
    if ($showCategoriesAccordion){
        ...
        if (is_string($categories_listing)) {
            ...
            if (LISTINGCATEGORY_SCALABILITY_OPTIMIZATION == "on") {
                $sideBarStr .= "        <li><a class=\"see-all\" href=\"".LISTING_DEFAULT_URL."/".ALIAS_ALLCATEGORIES_URL_DIVISOR.".php\">".system_showText(LANG_LISTING_VIEWALLCATEGORIES)."</a></li>";
            }
            $sideBarStr .="			</ul>
                                </li>";
        }
        ...
        if (EVENT_FEATURE == "on" && CUSTOM_EVENT_FEATURE == "on") {
            ...
            if ($categories_event) {
                ...
                if (EVENTCATEGORY_SCALABILITY_OPTIMIZATION == "on") {
                    $sideBarStr .="     <li><a class=\"see-all\" href=\"".EVENT_DEFAULT_URL."/".ALIAS_ALLCATEGORIES_URL_DIVISOR.".php\">".system_showText(LANG_EVENT_VIEWALLCATEGORIES)."</a></li>";
                }
                $sideBarStr .="     </ul>
                                </li>";
            }
        ...
        if (CLASSIFIED_FEATURE == "on" && CUSTOM_CLASSIFIED_FEATURE == "on") {
            if ($categories_classified) {
                ...
                if (CLASSIFIEDCATEGORY_SCALABILITY_OPTIMIZATION == "on") {
                    $sideBarStr .=" <li><a class=\"see-all\" href=\"".CLASSIFIED_DEFAULT_URL."/".ALIAS_ALLCATEGORIES_URL_DIVISOR.".php\">".system_showText(LANG_CLASSIFIED_VIEWALLCATEGORIES)."</a></li>";
                }
                $sideBarStr .="     </ul>
                                </li>";
            }
        ...
        if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") {
            ...
            if ($categories_article) {
                ...
                if (ARTICLECATEGORY_SCALABILITY_OPTIMIZATION == "on") {
                    $sideBarStr .="     <li><a class=\"see-all\" href=\"".ARTICLE_DEFAULT_URL."/".ALIAS_ALLCATEGORIES_URL_DIVISOR.".php\">".system_showText(LANG_ARTICLE_VIEWALLCATEGORIES)."</a></li>";
                }
                $sideBarStr .="     </ul>
                                </li>";
            }
        ...
        if (CUSTOM_HAS_PROMOTION == "on" && PROMOTION_FEATURE == "on" && CUSTOM_PROMOTION_FEATURE == "on"){
            ...
            if (is_string($categories_deal)) {
                ...
                if(count($xml_categories->info) > 0) {
                    ...
                    if (LISTINGCATEGORY_SCALABILITY_OPTIMIZATION == "on") {
                        $sideBarStr .= "    <li><a class=\"see-all\" href=\"".PROMOTION_DEFAULT_URL."/".ALIAS_ALLCATEGORIES_URL_DIVISOR.".php\">".system_showText(LANG_PROMOTION_VIEWALLCATEGORIES)."</a></li>";
                    }
                }
                $sideBarStr .="     </ul>
                                </li>";
