<?
	...
	include_once(CLASSES_DIR."/class_CURL.php");
	include_once(CLASSES_DIR."/class_GeoCoder.php");
	...
	####CODE ADDED BY ASHISH TO LANGUAGE LABEL CONSTANTS############
	include_once(EDIRECTORY_ROOT."/lang/en_us.php");
	include_once(EDIRECTORY_ROOT."/lang/en_us_sitemgr.php");
	################################################################
?>