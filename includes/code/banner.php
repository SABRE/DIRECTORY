<?
	...
	{
		$_POST["feature_onlocation1"] = $_POST["location_1"];
		if($_POST["location_2"])$_POST["feature_onlocation2"] = $_POST["location_2"];
		if($_POST["location_3"])$_POST["feature_onlocation3"] = $_POST["location_3"];
		if(!isset($_POST["approve_feature"]))$_POST["approve_feature"] = "n";
	}
