...
<table id="contact_info" border="0" cellpadding="2" cellspacing="0" class="standard-table standardSIGNUPTable noMargin">
	...
	<? if (string_strpos($_SERVER['PHP_SELF'], "/add/index.php") == true || string_strpos($_SERVER['PHP_SELF'], "add.php") == true || string_strpos($_SERVER['PHP_SELF'], "edit.php") == true || $_SERVER['PHP_SELF'] == "/".MEMBERS_ALIAS."/account/account.php") { ?>
