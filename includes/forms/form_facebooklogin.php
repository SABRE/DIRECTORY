...
<div class="button button-facebook">
	<h2>
		<? if (string_strpos($_SERVER["PHP_SELF"], "".MEMBERS_ALIAS."/login.php") !== false || string_strpos($_SERVER["PHP_SELF"], "profile/add.php") !== false || string_strpos($_SERVER["PHP_SELF"], "profile/edit.php") !== false || string_strpos($_SERVER["PHP_SELF"], "order") !== false || string_strpos($_SERVER["REQUEST_URI"], ALIAS_CLAIM_URL_DIVISOR."/") !== false){ ?>
