...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table">
	...
	<tr>
		<th colspan="2" class="widthAuto">
			<div class="tip-base">
				<span class="warning" style="text-align: justify;"><a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("header logo");?>" target="_blank"><?=system_showText(LANG_SITEMGR_HEADERLOGOTIP)?></a></span>
			</div>
		</th>
	</tr>
	<tr>
