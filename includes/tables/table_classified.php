...
?>
    ...
    <form name="item_table">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="standard-tableTOPBLUE arrow-manage">
            ...
            <tr>
                <th style="width: auto;">
                    <span style="width: auto;"><?=system_showText(LANG_CLASSIFIED_TITLE);?></span>
                    <? if ($orderLinks) { ?>
                ...
                <th style="width: <?=(string_strpos($url_base, "/".SITEMGR_ALIAS."") ? "18%;" : "15%;")?>">
            ...
            if ($classifieds) foreach ($classifieds as $classified) {
                ...
                <tr>
                    ...
                    <td nowrap>
                        ...
                        <? if ((GOOGLE_MAPS_ENABLED == "on") && ($mapObj->getString("value") == "on") && (($classified->getString("address")) || ($classified->getNumber("location_3")) || ($classified->getNumber("location_4")) || ($classified->getNumber("zip_code")) || ($classified->getString("latitude") && $classified->getString("longitude")))) { ?>
