<?
	...
	if ($tPreview) {
		...
		/*$listingChoices = Array();
		$listingChoices[0]=1;
		$listingChoices['id']=1;
		$listingChoices[1]='United States';
		$listingChoices['name']='United States';
		$listingChoices[2]='USA';
		$listingChoices['abbreviation']='USA';
		$listingChoices[3]='united-states';
		$listingChoices['friendly_url']='united-states';
		$listingChoices[4]='';
		$listingChoices['seo_description']='';
		$listingChoices[5]='';
		$listingChoices['seo_keywords']='';*/
		//print_r($listingChoices);die;
		if ($listingChoices) {
