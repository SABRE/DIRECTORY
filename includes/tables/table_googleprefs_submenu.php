...
<div class="submenu">
	<ul>
		<? if (GOOGLE_MAPS_ENABLED == "on") { ?>
			<? $has_menu_item = true; ?>
			<li id="privateMenu_maps"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/googleprefs/googlemaps.php"><?=string_ucwords(system_showText(LANG_SITEMGR_NAVBAR_GOOGLEMAPS))?></a></li>
		<? } ?>
		<? if (GOOGLE_ADS_ENABLED == "on") { ?>
			<li id="privateMenu_ads"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/googleprefs/googleads.php"><?=string_ucwords(system_showText(LANG_SITEMGR_NAVBAR_GOOGLEADS))?></a></li>
		<? } ?>		
		<? if (GOOGLE_ANALYTICS_ENABLED == "on") { ?>
			<? $has_menu_item = true; ?>
			<li id="privateMenu_analytics"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/googleprefs/googleanalytics.php"><?=string_ucwords(system_showText(LANG_SITEMGR_NAVBAR_GOOGLEANALYTICS))?></a></li>
		<? } ?>
	</ul>
</div>
