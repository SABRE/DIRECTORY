	...
	if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") {
		...
		if ($r && mysql_num_rows($r)>0) {
			...
			<table border="0" cellpadding="2" cellspacing="2" class="standard-tableTOPBLUE">
				...
				<tr>
					<th colspan="3"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".string_ucwords(system_showText(LANG_SITEMGR_ARTICLE_PLURAL))." &raquo;</a>" : "")?></span><?=string_ucwords(system_showText(LANG_SITEMGR_ARTICLE_PLURAL))?></th>
				</tr>
