...
<table class="table-table">
	...
	<tr class="tr-table">
		<td class="td-table">
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_header.php" class="link-table"><?=system_showText(LANG_SITEMGR_HEADER)?></a>
		</td>
		<td class="td-table">
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_header.php" class="link-table">
	...
	<tr class="tr-table">
		<td class="td-table">
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_footer.php" class="link-table"><?=system_showText(LANG_SITEMGR_FOOTER)?></a>
		</td>
		<td class="td-table">
			...
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_footer.php" class="link-table">
				<img src="<?=DEFAULT_URL?>/images/bt_edit.gif" alt="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" title="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" border="0" />
			</a>
			<img src="<?=DEFAULT_URL?>/images/bt_delete_off.gif" alt="<?=system_showText(LANG_SITEMGR_DELETE)?>" title="<?=system_showText(LANG_SITEMGR_DELETE)?>" border="0" />
		</td>
	...
	<tr class="tr-table">
		<td class="td-table">
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_noimage.php" class="link-table"><?=system_showText(LANG_SITEMGR_CONTENT_DEFAULTIMAGE)?> </a> <span class="itemNote"></span>
		</td>
		<td class="td-table">
			<img src="<?=DEFAULT_URL?>/images/icon_seof_off.gif" alt="<?=system_showText(LANG_SITEMGR_SEOCENTER_SEOFEATURE)?>" title="<?=system_showText(LANG_SITEMGR_SEOCENTER_SEOFEATURE)?>" border="0" />
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_noimage.php" class="link-table">
				<img src="<?=DEFAULT_URL?>/images/bt_edit.gif" alt="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" title="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" border="0" />
			</a>
			<img src="<?=DEFAULT_URL?>/images/bt_delete_off.gif" alt="<?=system_showText(LANG_SITEMGR_DELETE)?>" title="<?=system_showText(LANG_SITEMGR_DELETE)?>" border="0" />
		</td>
    ...
    <tr class="tr-table">
		<td class="td-table">
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_icon.php" class="link-table"><?=system_showText(LANG_SITEMGR_CONTENT_ICON)?> </a> <span class="itemNote"></span>
		</td>
		<td class="td-table">
			<img src="<?=DEFAULT_URL?>/images/icon_seof_off.gif" alt="<?=system_showText(LANG_SITEMGR_SEOCENTER_SEOFEATURE)?>" title="<?=system_showText(LANG_SITEMGR_SEOCENTER_SEOFEATURE)?>" border="0" />
			<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/content_icon.php" class="link-table">
				<img src="<?=DEFAULT_URL?>/images/bt_edit.gif" alt="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" title="<?=string_strtolower(system_showText(LANG_SITEMGR_EDIT))?>" border="0" />
			</a>
			<img src="<?=DEFAULT_URL?>/images/bt_delete_off.gif" alt="<?=system_showText(LANG_SITEMGR_DELETE)?>" title="<?=system_showText(LANG_SITEMGR_DELETE)?>" border="0" />
		</td>
