                ...
                <th style="width:auto;">
                    ...
                    <? if ($orderLinks) { ?>
                        <a href="<?=$paging_url."?order_by=caption_".($order_by == "caption_asc" ? "desc" : "asc")."&letter=$letter&screen=$screen".($url_search_params ? "&$url_search_params" : "")?>">
                            <img src="<?=DEFAULT_URL."/images/bg_arrow_".($order_by == "caption_asc" ? "up" : "down").".png"?>" title="<?=system_showText(@constant("LANG_CLICK_ORDERCAPTION".($order_by == "caption_asc" ? "DESC" : "ASC")))?>" />
                        </a>
                    <? } ?>
                </th>

                <th style="width: <?=(string_strpos($url_redirect, "/".SITEMGR_ALIAS."") ? "90px;" : "120px;")?>">
                    ...
                    <? if ($orderLinks) { ?>
                        <a href="<?=$paging_url."?order_by=level_".($order_by == "level_asc" ? "desc" : "asc")."&letter=$letter&screen=$screen".($url_search_params ? "&$url_search_params" : "")?>">
                            <img src="<?=DEFAULT_URL."/images/bg_arrow_".($order_by == "level_asc" ? "up" : "down").".png"?>" title="<?=system_showText(@constant("LANG_CLICK_ORDERTYPE".($order_by == "level_asc" ? "DESC" : "ASC")))?>" />
                        </a>
                    <? } ?>
                </th>
                ...
                <th style="width: 90px;">
					...
					<? if ($orderLinks) { ?>
                        <a href="<?=$paging_url."?order_by=impressions_".($order_by == "impressions_asc" ? "desc" : "asc")."&letter=$letter&screen=$screen".($url_search_params ? "&$url_search_params" : "")?>">
                            <img src="<?=DEFAULT_URL."/images/bg_arrow_".($order_by == "impressions_asc" ? "up" : "down").".png"?>" title="<?=system_showText(@constant("LANG_CLICK_ORDERIMPRESSIONS".($order_by == "impressions_asc" ? "DESC" : "ASC")))?>" />
                        </a>
                    <? } ?>
                </th>

                <th style="width: <?=(string_strpos($url_redirect, "/".SITEMGR_ALIAS."") ? "100px;" : "70px;")?>"><?=system_showText(LANG_LABEL_OPTIONS)?></th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <? if ( PAYMENTSYSTEM_FEATURE == "on" ) { ?>
                            ...
                            <? if($history_lnk && string_strpos($url_redirect, "/".SITEMGR_ALIAS."")) { ?>
                            ...
                            <? } elseif(string_strpos($url_redirect, "/".SITEMGR_ALIAS."")) { ?>
