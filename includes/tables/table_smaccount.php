	...
	<? $i = 0;
		...
		<tr class="tr-table">
			...
			<td class="td-table" nowrap>
				...
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/smaccount/view.php?id=<?=$smaccount->getNumber("id")?>&screen=<?=$screen?>&letter=<?=$letter?><?=(($url_search_params) ? "&$url_search_params" : "")?>" class="link-table" title="<?=$created_field?>">
					<?=$created_field?>
				</a>
			</td>
			...
			<td class="td-table" nowrap>
				...
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/smaccount/view.php?id=<?=$smaccount->getNumber("id")?>&screen=<?=$screen?>&letter=<?=$letter?><?=(($url_search_params) ? "&$url_search_params" : "")?>" class="link-table">
					<img src="<?=DEFAULT_URL?>/images/bt_view.gif" alt="<?=system_showText(LANG_SITEMGR_VIEW)?>" title="<?=system_showText(LANG_SITEMGR_VIEW)?>" border="0" />
				</a>

				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/smaccount/smaccount.php?id=<?=$smaccount->getNumber("id")?>&screen=<?=$screen?>&letter=<?=$letter?><?=(($url_search_params) ? "&$url_search_params" : "")?>" class="link-table">
					<img src="<?=DEFAULT_URL?>/images/bt_edit.gif" alt="<?=system_showText(LANG_SITEMGR_EDIT)?>" title="<?=system_showText(LANG_SITEMGR_EDIT)?>" border="0" />
				</a>
				...
				<? } else { ?>
					<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/smaccount/delete.php?id=<?=$smaccount->getNumber("id")?>&screen=<?=$screen?>&letter=<?=$letter?><?=(($url_search_params) ? "&$url_search_params" : "")?>" class="link-table">
						<img src="<?=DEFAULT_URL?>/images/bt_delete.gif" alt="<?=system_showText(LANG_SITEMGR_DELETE)?>" title="<?=system_showText(LANG_SITEMGR_DELETE)?>" border="0" />
					</a>
				<? } ?>
