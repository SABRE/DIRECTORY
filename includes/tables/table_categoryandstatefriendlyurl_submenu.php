...
$openPMhome = string_strpos($_SERVER["PHP_SELF"], "categoryandstatefriendlyurl.php");
$openPMadd =  string_strpos($_SERVER["PHP_SELF"], "categoryandstatefriendlyurladd.php");
$openPMsearch = string_strpos($_SERVER["PHP_SELF"], "categoryandstatefriendlyurlsearch.php");
...
<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/friendlyurl/categoryandstate/categoryandstatefriendlyurl.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a></li>
		<li id="privateMenu_add"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/friendlyurl/categoryandstate/categoryandstatefriendlyurladd.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/friendlyurl/categoryandstate/categoryandstatefriendlyurlsearch.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
		<?
