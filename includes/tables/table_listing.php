...
?>
    ...
    if (is_numeric($messageBacklink) && isset($msg_listing[$messageBacklink])) {
        echo "<p class=\"".($messageBacklink == 10 ? "successMessage" : "errorMessage"."\">").$msg_listing[$messageBacklink]."</p>";
    } 
	...
	<form name="item_table">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="standard-tableTOPBLUE arrow-manage">
            ...
            <tr>
                <th style="width: auto;">
                	<span style="width: auto;"><?=system_showText(LANG_LISTING_TITLE);?></span>
					<? if ($orderLinks) { ?>
                ...
                <th style="width: <?=(string_strpos($url_base, "/".SITEMGR_ALIAS."") ? "22%;" : "20%;")?>">
            ...
            if ($listings) foreach ($listings as $listing) {
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        ...
                        <? if ((GOOGLE_MAPS_ENABLED == "on") && ($mapObj->getString("value") == "on") && (($listing->getString("address")) || ($listing->getNumber("location_3")) || ($listing->getNumber("location_4") || $listing->getString("zip_code") || ($listing->getString("latitude") && $listing->getString("longitude"))))) { ?>
