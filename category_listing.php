<?
	...
	if($_GET["fnct"] && $_GET["fnct"] == "categories"){
		...
		echo system_advancedSearch_categoryListing($_GET["type"],(isset($_GET["filter"])?true:false),$selected_category_id,$show_type,$main_id,$template_id,$selected_category_id_sub);	
	}
?>