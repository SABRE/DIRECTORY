...
?>
		...
		<div class="footer">
			...
			<div class="wrapper">
				...
				<p class="copyright">
					<span class="basePowered">Powered by <a href="http://www.edirectory.com" target="_blank">eDirectory&trade; <?=VERSION?></a>.</span>
					Interface design Copyright &copy; Arca Solutions Inc. Developers of eDirectory.
				</p>
