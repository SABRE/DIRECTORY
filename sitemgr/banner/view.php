...
<div id="main-right">
    ...
    <div id="content-content">
        ...
        <div class="default-margin">
            ...
            <center>
                <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=BANNER_FEATURE_FOLDER;?>/preview.php?id=<?=$banner->getNumber("id")?>" class="standardLINK iframe fancy_window_preview_small"><?=system_showText(LANG_SITEMGR_CLICKHERETOPREVIEW)?> <?=system_showText(LANG_SITEMGR_BANNER)?></a>
            </center>
