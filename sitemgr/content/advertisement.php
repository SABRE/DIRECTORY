	...
	<div id="content-content">
		...
		<div class="default-margin">
            ...
            <table class="table-table">
                ...
                <tr class="tr-table">
                    <td class="td-table">
                        <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/contentlevel.php?section=listing&value=<?=$value?>" class="link-table">
            ...
            ?>
	            <table class="table-table">
	               <tr class="th-table">
	                    ...
	                    <tr class="tr-table">
	                        <td class="td-table">
	                            <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/contentlevel.php?section=event&value=<?=$value?>" class="link-table">
            ...
            ?>
	            <table class="table-table">
	                <tr class="th-table">
	                    ...
	                    <tr class="tr-table">
	                        <td class="td-table">
	                            <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/contentlevel.php?section=classified&value=<?=$value?>" class="link-table">
            ...
            ?>
	            <table class="table-table">
	                <tr class="th-table">
	                    ...
	                    <tr class="tr-table">
	                        <td class="td-table">
	                            <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/contentlevel.php?section=article&value=<?=$value?>" class="link-table">
            ...
            ?>
	            <table class="table-table">
	                <tr class="th-table">
	                    ...
	                    <tr class="tr-table">
	                        <td class="td-table">
	                            <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/contentlevel.php?section=banner&value=<?=$value?>" class="link-table">
