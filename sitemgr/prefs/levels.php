		...
		if($_POST["listinglevelnames"]) {
			...
			if (validate_form("listinglevelnames", $_POST, $error)) {
                ...
                foreach ($levelsArray as $levelValue) {
                    ...
                    $levelObj->updateValues(string_strtolower($nameLevel[$levelValue]), $activeLevel[$levelValue], ($_POST["activeLevel"][$levelValue] == 'y' ? $hasPromotion[$levelValue] : 'n'), ($_POST["activeLevel"][$levelValue] == 'y' ? $hasReview[$levelValue] : 'n'), ($_POST["activeLevel"][$levelValue] == 'y' ? $hasSms[$levelValue] : 'n'), ($_POST["activeLevel"][$levelValue] == 'y' ? $hasCall[$levelValue] : 'n'), ($_POST["activeLevel"][$levelValue] == 'y' ? $backlink[$levelValue] : 'n'), $levelValue);
                }
